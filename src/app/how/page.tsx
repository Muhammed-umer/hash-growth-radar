    ...
    <div>
      ...
      <Section title="7 · How the score is calculated">
        <div className="rounded-xl border border-stone-200 bg-white p-4 text-sm text-stone-700">
          <p>
            <b>Fit</b> is not shown on the card, but the score is built from it. It is Gemini&apos;s own judgement, 0 to 100, of how directly a food tracker that understands medicines and conditions answers that exact comment. The prompt gives it these bands: a food question naming a medicine, or naming a condition and a specific food, 85 to 100; a vague food question naming a condition, or a request for an app for Indian food or a medical condition, 70 to 84; a generic app request, or a complaint that a named app fails on Indian food or ignores medicines, 55 to 69; a general nutrition question with no medicine or condition, 20 to 50; irrelevant, 0 to 10. If the rule check downgrades an &ldquo;asking for an app&rdquo; tag to a nutrition question, fit is capped at 50 to match.
          </p>
          <p className="mt-2">
